 ...
 */
const PRESENTATION: Record<NextActionKind, { label: string; icon: React.ReactNode; tone: string }> = {
  sla_breached: {
    label: "Answer now",
      ...
      <CardHeader className="pb-3">
        ...
        <CardDescription>
          {actions.length === 0
            ...
            : `${actions.length} thing${actions.length === 1 ? "" : "s"} to pick up, most pressing first.`}
        </CardDescription>
      </CardHeader>
      ...
      <CardContent className="pt-0">
        {actions.length === 0 ? (
          <div className="flex items-center gap-2 py-6 text-muted-foreground text-sm">
            ...
            <span>Every deal, quote and ticket you own is on track.</span>
          </div>
        ) : (
