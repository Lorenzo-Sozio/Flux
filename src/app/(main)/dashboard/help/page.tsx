...
const sections = [
  ...
  {
    // No screen of its own: it is Ctrl+K, the quick-create menu and the recents
    // list, which are reached from wherever the reader already is.
    id: "ricerca-rapida",
    key: "quickAccess",
    icon: Command,
  ...
  {
    // Its own section rather than the tail of Preventivi: nobody looking for a
    // credit note or the stamp duty opens "Quotes" to find it.
    id: "fatturazione",
    key: "invoicing",
    icon: Receipt,
    color: "text-emerald-500",
  ...
  {
    // Installing is done from the phone's own browser, so there is no screen
