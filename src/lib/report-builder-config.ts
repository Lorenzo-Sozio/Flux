...
export const ENTITY_CONFIGS: Record<string, EntityConfig> = {
  ...
  companies: {
    ...
    fields: [
      ...
      { key: "type",               label: "Type",              type: "enum",   enumValues: ["prospect","customer","partner","vendor"], groupable: true },
  ...
  leads: {
    ...
    fields: [
      ...
      { key: "status",             label: "Status",            type: "enum",   enumValues: ["new","contacting","engaged","qualified","unqualified"], groupable: true },
      { key: "source",             label: "Source",            type: "text",   groupable: true },
  ...
  quotes: {
    ...
    fields: [
      ...
      { key: "status",             label: "Status",            type: "enum",   enumValues: ["draft","pending_approval","sent","viewed","accepted","declined","expired"], groupable: true },
  ...
  tasks: {
    ...
    fields: [
      ...
      { key: "priority",           label: "Priority",          type: "enum",   enumValues: ["low","normal","high","critical","blocker"], groupable: true },
