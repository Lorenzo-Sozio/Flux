...
|---|---|---|---|
| 1 | L5 | Assegnazione per regola | L1 e L4 sono fatte. |
| 2 | L7 | Contratti e rinnovi | Autonoma. |
| 3 | L6 | Sequenze di follow-up | La più grande del gruppo, per ultima. |
