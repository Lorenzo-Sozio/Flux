...
|---|---|---|---|
| 1 | I5 | XML FatturaPA TD01/TD04 | Perimetro D2. |
| 2 | I7 | Copia di cortesia e archiviazione | Non dipende dal canale SDI. |
| 3 | I8 | Note di credito | Dopo la fattura. |
| 4 | L3 | Listini, percentuale e prezzi espliciti | D4. |
| 5 | L9 | Ambiti delle chiavi API per entità, poi API di lettura | D7. |
