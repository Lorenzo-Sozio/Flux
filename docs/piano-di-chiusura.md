...
|---|---|---|---|
| 1 | I3 | Fattura e righe, da un ordine | Una fattura per ordine (D3). |
| 2 | I4 | Numerazione progressiva senza buchi | All'emissione, mai in bozza. |
| 3 | I5 | XML FatturaPA TD01/TD04 | Perimetro D2. |
| 4 | I7 | Copia di cortesia e archiviazione | Non dipende dal canale SDI. |
| 5 | I8 | Note di credito | Dopo la fattura. |
| 6 | L3 | Listini, percentuale e prezzi espliciti | D4. |
| 7 | L9 | Ambiti delle chiavi API per entità, poi API di lettura | D7. |
